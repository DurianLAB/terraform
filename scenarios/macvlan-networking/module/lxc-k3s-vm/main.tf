# Macvlan Networking Scenario - Production Environment
# This configuration uses LXD macvlan networks for direct external access
# VMs are accessible from external network but isolated from host
